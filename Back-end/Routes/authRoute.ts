...
import {login, signUp, biometricLogin,verifyOtp, chooseAccount } from "../controllers/authController";
...
authRoute.route('/chooseAccount/:id').post(validatorMiddleware,chooseAccount);
